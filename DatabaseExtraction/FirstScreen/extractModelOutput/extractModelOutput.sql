...
DAY_type,HOUR,HOURLYABS,DBABS,0,0,WINDABS,SUNABS,PREDicted,actual,TEMP,WetBULB,DEWPOINT,WINDSPEED,SKY,DAYLIGHTHOUR,if(HOLIDAY = 0,1,0) HOLIDAY,date_format(Day,'%m/%d/%Y'),global_horizontal_irradiance
